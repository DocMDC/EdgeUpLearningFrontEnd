  ...
  return (
    <div className="min-h-[900px] w-screen flex flex-col items-center mb-12">
      <div className="font-serif text-xs mt-6 w-1/2">
          ...
          <h6 className="mb-6 md:text-lg">At Edge Up Learning, we are committed to protecting the privacy and security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your data when you visit our website and use our software platform.
          </h6>
          <h3 className="mb-6 md:text-lg">By accessing or using Edge Up Learning, you consent to the practices described in this Privacy Policy. If you do not agree with our policies and practices, please do not use our website or services.</h3>
          <h2 className="text-lg font-bold md:text-xl">Information We Collect</h2>
          <ol className="list-decimal pl-4 mt-2 space-y-2">
              <li className="md:text-lg"><strong>Personal Information:</strong> We may collect personal information, such as your name and email address, when you voluntarily provide it to us while using Edge Up Learning or during the registration process.</li>
          ...
          <ol className="list-decimal pl-4 mt-2 space-y-2">
              <li className="md:text-lg"><strong>To Provide and Improve Services:</strong> We use your personal information to operate and maintain Edge Up Learning, to communicate with you, and to enhance your user experience. This includes responding to your inquiries, providing customer support, and sending administrative information.</li>
              ...
              <li className="md:text-lg"><strong>To Protect Rights and Safety:</strong> We may use your information to enforce our terms of service, prevent fraud or potential illegal activities, and protect the rights, property, or safety of Edge Up Learning, its users, or others.</li>
          </ol>
          ...
          <ul className="mt-2">
              <li className="md:text-lg">You have the right to access, update, or delete your personal information. If you wish to exercise any of these rights or have questions about your data, please contact us at support@edgeuplearning.com.</li>
          </ul>
          ...
          <ul className="mt-2">
              <li className="md:text-lg">If you have any questions or concerns about this Privacy Policy or our data practices, please contact us at support@edgeuplearning.com.</li>
          </ul>
      </div>
